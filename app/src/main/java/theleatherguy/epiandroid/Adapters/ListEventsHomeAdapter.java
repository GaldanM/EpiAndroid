...
public class ListEventsHomeAdapter extends ArrayAdapter<Infos.Board.Project>
{
	public ListEventsHomeAdapter(Context context, List<Infos.Board.Project> listProjects)
	{
